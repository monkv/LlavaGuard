...
if __name__ == "__main__":
    ...
    model_dir = args.model_dir if args.model_dir is not None else "Qwen/Qwen2.5-VL-7B-Instruct"
    data_path = args.data_path if args.data_path is not None else f"{local_data_dir}/PEGI-Guard-DS/v2/test.json"

    output_dir = args.output_dir if args.output_dir is not None else f"{local_data_dir}/PEGI-Guard-DS/v2/eval/base_model/qwen_assessment_eval.json"
    responses_path = args.responses_path if args.output_dir is not None else f"{local_data_dir}/PEGI-Guard-DS/v2/eval/base_model/qwen_responses_assess.json"
